    ...
    <div className="flex md:flex-row flex-col md:gap-0 gap-3 items-center py-6">
      ...
      <div className="dark:text-[#a9a9b3] text-[#222222]">
        ...
        <div className="flex items-center gap-2 mb-4">
          {live && (
            <a href={live} className="font-medium rounded-full bg-blue-500 text-white px-3 py-0.5 flex items-center text-sm" target="_blank">
              <AiOutlineThunderbolt /> Live
            </a>
          )}
          <a href={source} className="font-medium rounded-full bg-violet-500 text-white px-3 py-0.5 flex items-center text-sm" target="_blank">
            <FaCodeBranch /> Source
          </a>
        </div>
        <p>{description}</p>
