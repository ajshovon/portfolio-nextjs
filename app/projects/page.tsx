  ...
  const projects = [
    {
      ...
      description:
        "PitchBlack Recovery Project is an open source custom recovery for android by developers from different countries with an aim to provide an advanced recovery with better customizations, themes and features.",
    ...
    },
    {
      ...
      name: "pyRunner",
      description:
        "A telegram bot to run python codes. By providing a platform for running Python code within Telegram, this bot facilitates quick testing, learning, and experimenting with Python without the need for a separate development environment.",
      image: "/assets/images/pyrunner.png",
      live: "",
